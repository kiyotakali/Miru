...
void LAppMinimumLive2DManager::OnUpdate() const
{
    ...
    // Wallpaper layout: shrink model to ~55% and position in lower third
    // so it sits below app icons / lock screen clock
    projection.ScaleRelative(0.55f, 0.55f);
    projection.TranslateRelative(0.0f, -0.35f);
